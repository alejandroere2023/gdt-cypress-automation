...
//------------------------------Transferir Arquero------------------------------    
    it('Cambio Arquero', ()=>{
        ...
        cy.get('[href="/mi-equipo/futbol-11"]').click();
        ...
        cy.get('.max-h-11 > :nth-child(2)',  {timeout: 15000}).click();
        cy.wait(2000)

        //Confirma Cambio
        cy.get('.pb-10 > .relative').click()

        //Selecciona Jugador
        //cy.get('[style="position: absolute; top: 91px; left: 0px; width: 100%; height: 91px;"] > .justify-between',  {timeout: 15000}).click();
        cy.wait(2000)
        //Confirma
...
//------------------------------Transferir Defensor------------------------------    
    it('Cambio Arquero', ()=>{
        ...
        //Selecciona Defensor Suplente
        cy.get('#refPlayerField-12 > .h-15',   {timeout: 15000}).click();
        cy.wait(2000)
        //Selecciona Transferir en el Pop
        cy.get('.max-h-11 > :nth-child(2)',  {timeout: 15000}).click();
        cy.wait(2000)
        ...
        //Selecciona Defensor A cambiar
        cy.get('#refPlayerField-3 > .h-15',   {timeout: 15000}).click();
        cy.wait(2000)
