<<<<<<< HEAD
    //------------------------------Transferir Delantero Mayor Puntaje------------------------------
        ...
        //Selecciona TDA
        cy.contains('button', 'Torneos de Amigos')
            .should('be.visible')
            .click()

         //Selecciona TDA Clásico
        // Ahora sí, el item final
        cy.contains('Torneos de Amigos Clásicos', { timeout: 10000 })
        .should('be.visible')
        .click({ force: true })
        cy.wait(2000)


        //Es llevado al Home de TDA Clásico y selecciona Crear TDA
        ...
        cy.get('#tourneyName', {timeout: 15000})
            .click({ force: true })
            .type('TDA Automation 4', { force: true })
        cy.wait(2000)
